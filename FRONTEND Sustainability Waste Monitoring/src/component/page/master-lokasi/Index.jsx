...
export default function MasterLokasiIndex({ onChangePage }) {
  ...
  function handleSetStatus(id) {
    setIsLoading(true);
    setIsError(false);
    UseFetch(API_LINK + "MasterLokasi/SetStatusLokasi", {
      idLokasi: id,
    })
      .then((data) => {
        if (data === "ERROR" || data.length === 0) setIsError(true);
          ...
          SweetAlert(
            "Sukses",
            "Status data lokasi berhasil diubah menjadi " + data[0].Status,
            "success"
          );
      ...
      <div className="d-flex flex-column">
        {isError && (
          <div className="flex-fill">
            <Alert
              type="warning"
              message="Terjadi kesalahan: Gagal mengambil data lokasi."
            />
          </div>
        )}
        <div className="flex-fill">
