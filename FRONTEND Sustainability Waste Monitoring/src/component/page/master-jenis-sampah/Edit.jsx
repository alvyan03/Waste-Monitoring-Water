...
export default function MasterJenisSampahEdit({ onChangePage, withID }) {
    ...
    const fetchData = async () => {
      ...
      try {
        const data = await UseFetch(
          API_LINK + "MasterJenisSampah/GetDataJenisSampahById",
          { id: withID }
        );
  ...
  const handleAdd = async (e) => {
    ...
    if (Object.values(validationErrors).every((error) => !error)) {
      ...
      try {
        ...
        const data = await UseFetch(
          API_LINK + "MasterJenisSampah/EditJenisSampah",
          formDataRef.current
        );
